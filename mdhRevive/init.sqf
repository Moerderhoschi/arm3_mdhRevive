/////////////////////////////////////////////////////////////////////////////////////
// MDH REVIVE FOR ALL PLAYERS(by Moerderhoschi) - v2025-06-12
				...
				if(_c) then
				{
					...
					[
						...
						[
							...
							+ '<br/>'
							+    '<font color="#33CC33"><execute expression = "[''mdhReviveAutoReviveTime'',30,''MDH Revive Autorevive set 30 sec''] call mdhReviveModBriefingFnc">0.5</execute></font color>'
							+ ' / <font color="#33CC33"><execute expression = "[''mdhReviveAutoReviveTime'',60,''MDH Revive Autorevive set 1 min''] call mdhReviveModBriefingFnc">1</execute></font color>'
							+ ' / <font color="#33CC33"><execute expression = "[''mdhReviveAutoReviveTime'',120,''MDH Revive Autorevive set 2 min''] call mdhReviveModBriefingFnc">2</execute></font color>'
							+ ' / <font color="#33CC33"><execute expression = "[''mdhReviveAutoReviveTime'',180,''MDH Revive Autorevive set 3 min''] call mdhReviveModBriefingFnc">3</execute></font color>'
							+ ' / <font color="#33CC33"><execute expression = "[''mdhReviveAutoReviveTime'',240,''MDH Revive Autorevive set 4 min''] call mdhReviveModBriefingFnc">4</execute></font color>'
							+ ' / <font color="#33CC33"><execute expression = "[''mdhReviveAutoReviveTime'',300,''MDH Revive Autorevive set 5 min''] call mdhReviveModBriefingFnc">5</execute></font color>'
							+ ' / <font color="#33CC33"><execute expression = "[''mdhReviveAutoReviveTime'',360,''MDH Revive Autorevive set 6 min''] call mdhReviveModBriefingFnc">6</execute></font color>'
							+ ' / <font color="#33CC33"><execute expression = "[''mdhReviveAutoReviveTime'',420,''MDH Revive Autorevive set 7 min''] call mdhReviveModBriefingFnc">7</execute></font color>'
							+ ' / <font color="#33CC33"><execute expression = "[''mdhReviveAutoReviveTime'',480,''MDH Revive Autorevive set 8 min''] call mdhReviveModBriefingFnc">8</execute></font color>'
							+ ' / <font color="#33CC33"><execute expression = "[''mdhReviveAutoReviveTime'',540,''MDH Revive Autorevive set 9 min''] call mdhReviveModBriefingFnc">9</execute></font color>'
							+ ' / <font color="#33CC33"><execute expression = "[''mdhReviveAutoReviveTime'',600,''MDH Revive Autorevive set 10 min''] call mdhReviveModBriefingFnc">10</execute></font color>'
							...
							+ ' -> set Autorevive in min'
							+ '<br/>'
							+    '<font color="#33CC33"><execute expression = "[''bis_revive_Bleedoutduration'',30,''MDH Revive BleedoutTime set 30 sec''] call mdhReviveModBriefingFnc">0.5</execute></font color>'
							+ ' / <font color="#33CC33"><execute expression = "[''bis_revive_Bleedoutduration'',60,''MDH Revive BleedoutTime set 1 min''] call mdhReviveModBriefingFnc">1</execute></font color>'
							+ ' / <font color="#33CC33"><execute expression = "[''bis_revive_Bleedoutduration'',120,''MDH Revive BleedoutTime set 2 min''] call mdhReviveModBriefingFnc">2</execute></font color>'
							+ ' / <font color="#33CC33"><execute expression = "[''bis_revive_Bleedoutduration'',180,''MDH Revive BleedoutTime set 3 min''] call mdhReviveModBriefingFnc">3</execute></font color>'
							+ ' / <font color="#33CC33"><execute expression = "[''bis_revive_Bleedoutduration'',240,''MDH Revive BleedoutTime set 4 min''] call mdhReviveModBriefingFnc">4</execute></font color>'
							+ ' / <font color="#33CC33"><execute expression = "[''bis_revive_Bleedoutduration'',300,''MDH Revive BleedoutTime set 5 min''] call mdhReviveModBriefingFnc">5</execute></font color>'
							+ ' / <font color="#33CC33"><execute expression = "[''bis_revive_Bleedoutduration'',360,''MDH Revive BleedoutTime set 6 min''] call mdhReviveModBriefingFnc">6</execute></font color>'
							+ ' / <font color="#33CC33"><execute expression = "[''bis_revive_Bleedoutduration'',420,''MDH Revive BleedoutTime set 7 min''] call mdhReviveModBriefingFnc">7</execute></font color>'
							+ ' / <font color="#33CC33"><execute expression = "[''bis_revive_Bleedoutduration'',480,''MDH Revive BleedoutTime set 8 min''] call mdhReviveModBriefingFnc">8</execute></font color>'
							+ ' / <font color="#33CC33"><execute expression = "[''bis_revive_Bleedoutduration'',540,''MDH Revive BleedoutTime set 9 min''] call mdhReviveModBriefingFnc">9</execute></font color>'
							+ ' / <font color="#33CC33"><execute expression = "[''bis_revive_Bleedoutduration'',600,''MDH Revive BleedoutTime set 10 min''] call mdhReviveModBriefingFnc">10</execute></font color>'
